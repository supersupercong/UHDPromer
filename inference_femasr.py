...
def main():
    ...
    parser.add_argument('-w', '--weight', type=str, default='/data1/wangcong/CVPR23-derain/FeMaSR-main/experiments/008_FeMaSR_HQ_stage/models/net_g_45000.pth', help='path for model weights')
    ...
    # set up the model
    sr_model = FeMaSRNet(codebook_params=[[32, 1024, 512]], LQ_stage=False, scale_factor=args.out_scale).to(device)
